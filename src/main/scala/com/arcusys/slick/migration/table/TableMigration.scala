...
import com.arcusys.slick.migration.ast.{ AstHelpers, ColumnInfo, TableInfo }
 ...
 * A table migration is a [[com.arcusys.slick.migration.Migration]] that performs changes to a table.
 *
 ...
 *
 * Like all [[com.arcusys.slick.migration.Migration]]s, you can run the resulting [[TableMigration]] by calling its
 * `apply` method (it expects an implicit `Session`). Being an [[com.arcusys.slick.migration.SqlMigration]] you
