...
import slick.migration.ast.{ AstHelpers, ColumnInfo, IndexInfo, TableInfo }
import slick.migration.table.TableMigrationData
 ...
 * [[slick.migration.table.TableMigration#sql]].
